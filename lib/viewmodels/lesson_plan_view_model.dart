...
class LessonPlanViewModel extends ChangeNotifier {
  ...
  String get formattedLessonPlan {
    ...
    if (lessonPlan['teaching_methodology'] != null && lessonPlan['teaching_methodology'].toString().isNotEmpty) {
    ...
    // Assessment Methods
    if (lessonPlan['assessment_methods'] != null && (lessonPlan['assessment_methods'] as List).isNotEmpty) {
