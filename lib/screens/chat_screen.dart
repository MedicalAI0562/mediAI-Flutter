...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _clearSelectedBookAndStartNewChat(ChatViewModel chatViewModel) async {
    try {
      ...
      _showErrorSnackBar('Failed to clear book and start new chat. Please try again.');
          ...
          if (!message.isUser) ...[
            CircleAvatar(
              ...
              child: Icon(
                isError 
                    ? Icons.error_outline
                    : isMediAI ? Icons.medical_services : Icons.smart_toy,
                size: 4.w,
                color: isError
                    ? Colors.red
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  ...
                  bottomLeft: message.isUser ? Radius.circular(4.w) : Radius.circular(1.w),
                  bottomRight: message.isUser ? Radius.circular(1.w) : Radius.circular(4.w),
                ),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                    ...
                    Row(
                      ...
                      children: [
                        Icon(
                          ...
                          size: 3.5.w,
                          color: isMediAI ? AppColors.primaryPurple : Colors.blue,
                        ),
                  ...
                  if (isTyping) 
                    ...
                    Text(
                      message.isUser ? message.text : _removeSymbols(message.text),
                      style: TextStyle(
                        fontSize: 3.5.w,
                        color: message.isUser 
                            ? AppColors.white 
                    ...
                    if (!message.isUser && message.webResults != null && message.webResults!.isNotEmpty) ...[
                      SizedBox(height: 1.5.h),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.language_outlined, size: 4.w, color: AppColors.primaryPurple),
              SizedBox(width: 2.w),
              Expanded(
                child: Text(
                  'Relevant resources',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (snippet.isNotEmpty) ...[
                      ...
                      Text(
                        snippet,
                        style: TextStyle(fontSize: 2.6.w, color: Colors.black87),
                      ),
                    ],
                    SizedBox(height: 0.4.h),
                    Row(
                      children: [
                        if (source.isNotEmpty) ...[
                          Icon(Icons.source, size: 2.8.w, color: Colors.grey[700]),
                          SizedBox(width: 1.w),
                          Flexible(
                            child: Text(
                              source,
                              style: TextStyle(fontSize: 2.4.w, color: Colors.grey[700]),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ),
                        ],
                        if (score != null) ...[
                          SizedBox(width: 2.w),
                          Icon(Icons.star_rate_rounded, size: 3.w, color: Colors.amber[700]),
                          SizedBox(width: 0.5.w),
                          Text('Relevance: $score', style: TextStyle(fontSize: 2.4.w, color: Colors.grey[700])),
                        ],
                      ],
                    ),
                    if (link.isNotEmpty) ...[
            ...
            builder: (context, value, child) {
              ...
              return Transform.translate(
                ...
                child: Container(
                  ...
                  height: 1.5.w,
                  decoration: BoxDecoration(
                    color: AppColors.primaryPurple.withOpacity(0.3 + bounceValue * 0.4),
