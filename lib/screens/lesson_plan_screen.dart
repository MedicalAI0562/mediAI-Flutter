...
class _LessonPlanScreenState extends State<LessonPlanScreen> {
                ...
                children: [
                  SizedBox(
                    ...
                    child: CircularProgressIndicator(
                      strokeWidth: 2,
                      valueColor: AlwaysStoppedAnimation<Color>(AppColors.primaryGradient[0]),
                    ),
                  ),
                  SizedBox(width: 3.w),
                  Text(
          ...
          if (_selectedChapters.isNotEmpty)
            Container(
              ...
              child: Wrap(
                spacing: 2.w,
                runSpacing: 1.h,
                children: _selectedChapters.map((chapter) {
                  return Container(
        ...
        children: [
          Row(
            children: [
              ...
              Spacer(),
              IconButton(
                onPressed: () => _copyToClipboard(viewModel.formattedLessonPlan),
                icon: Icon(
                  Icons.copy,
                  color: AppColors.primaryGradient[0],
                  size: 4.w,
  ...
  void _generateLessonPlan() {
    if (_selectedBook == null || _selectedChapters.isEmpty) {
    ...
    context.read<LessonPlanViewModel>().generateLessonPlan(
      ...
      chapterNames: _selectedChapters,
    );
  }
  ...
  Future<void> _downloadAsPDF(LessonPlanViewModel viewModel) async {
    try {
          ...
          build: (pw.Context context) {
            return [
              ...
              if (lessonPlan['learning_objectives'] != null) ...[
                ...
                ...(lessonPlan['learning_objectives'] as List).asMap().entries.map((entry) {
                  return pw.Padding(
              ...
              if (lessonPlan['key_concepts'] != null) ...[
                ...
                pw.SizedBox(height: 10),
                ...(lessonPlan['key_concepts'] as List).asMap().entries.map((entry) {
                  return pw.Padding(
                    padding: pw.EdgeInsets.only(left: 10, bottom: 5),
                    child: pw.Row(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
              ...
              if (lessonPlan['assessment_methods'] != null && 
                ...
                pw.SizedBox(height: 10),
                ...(lessonPlan['assessment_methods'] as List).asMap().entries.map((entry) {
                  return pw.Padding(
                    padding: pw.EdgeInsets.only(left: 10, bottom: 5),
                    child: pw.Row(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
              ...
              if (lessonPlan['resources'] != null) ...[
                ...
                pw.SizedBox(height: 10),
                ...(lessonPlan['resources'] as List).asMap().entries.map((entry) {
                  return pw.Padding(
                    padding: pw.EdgeInsets.only(left: 10, bottom: 5),
                    child: pw.Row(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
      ...
      final fileName = 'lesson_plan_${DateTime.now().millisecondsSinceEpoch}.pdf';
