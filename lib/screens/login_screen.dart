...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
  ...
  void _loadRememberMeState() async {
    try {
      ...
      bool isValidEmail = savedUsername.isNotEmpty && emailRegex.hasMatch(savedUsername);
              ...
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: ResponsiveUtils.isMobile(context) ? 1.h : 1.5.h),
                    ...
                    SizedBox(height: ResponsiveUtils.isMobile(context) ? 4.h : 6.h),
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.all(ResponsiveUtils.isMobile(context) ? 5.w : 4.w),
                      decoration: BoxDecoration(
                        color: Colors.white.withOpacity(0.1),
                        borderRadius: BorderRadius.circular(ResponsiveUtils.isMobile(context) ? 16 : 20),
                        border: Border.all(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: ResponsiveUtils.isMobile(context) ? 2.h : 3.h),

                          // Password Field
                          _buildEnhancedPasswordField(),
                          SizedBox(height: ResponsiveUtils.isMobile(context) ? 1.5.h : 2.h),
                    ...
                    SizedBox(height: ResponsiveUtils.isMobile(context) ? 3.h : 4.h),
  ...
  Widget _buildEnhancedUsernameField() {
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(ResponsiveUtils.isMobile(context) ? 10 : 12),
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(0.1),
            blurRadius: 10,
