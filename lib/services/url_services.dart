...
class UrlServices {
  ...
  static const String BASE_URL = 'https://doctorjebasingh.in';
  
  // CORS Proxy for development (uncomment to use)
  // static const String BASE_URL = 'https://cors-anywhere.herokuapp.com/https://doctorjebasingh.in';
  
  // Authentication endpoints
  static const String LOGIN = 'api/login';       // Primary login endpoint
  static const String LOGIN_ALT = 'login';       // Alternative login endpoint
  ...
  static const String BOOKS_LIST = 'books';           // Simple books endpoint
  static const String BOOKS_LIST_CATEGORIZED = 'ai/books-list'; // Categorized books (chapter vs non-chapter)
  static const String BOOKS_CHAPTER = 'ai/books/chapter';      // Chapter-wise books
  static const String BOOKS_NON_CHAPTER = 'ai/books/non-chapter'; // Non-chapter books
  static const String AI_BOOK = 'ai/book';            // Base for specific book routes
  static const String AI_BOOKS = 'ai/books';          // Base for specific book routes (plural)
  
  // Exams / Question generation
  static const String EXAMS = 'api/exams';
  static const String GENERATE_QUESTIONS = 'ai/generate-questions';
  ...
  // Chat endpoints
  static const String CHAT = 'ai/chat';               // Chat with AI endpoint
  static const String NEW_SESSION = 'ai/new_session'; // Start new chat session
  static const String SESSIONS = 'ai/sessions';       // Get chat sessions history
  static const String SESSION_MESSAGES = 'ai/session'; // Get messages for specific session
  static const String SELECT_BOOKS = 'ai/select_books'; // Select books for chat context
  static const String TOGGLE_BOOKS_MODE = 'ai/toggle_books_mode'; // Toggle chapter/non-chapter mode
  
  // Lesson Plan endpoints
  static const String LESSON_PLAN = 'ai/lesson-plan'; // Generate lesson plan endpoint
